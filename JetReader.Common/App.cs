...
#if DEBUG
                ConfigurationManager.Initialise(assembly.GetManifestResourceStream("JetReader.ReaderApp.config"));
#else
                ConfigurationManager.Initialise(assembly.GetManifestResourceStream("JetReader.ReaderApp.Release.config"));
#endif
            }
        }
    }
