...
namespace JetReader.Service {
    public class WebViewMessages {
        ...
        private void Parse(string data) {
            ...
            var messageType = Type.GetType($"JetReader.Model.WebViewMessages.{json.Action}");
            ...
            foreach (var cls in Assembly.GetExecutingAssembly().GetTypes().Where(p => p.IsClass && p.Namespace == "JetReader.Model.WebViewMessages"))
